  ...
  return (
    <nav className="flex items-center justify-between flex-wrap bg-white p-6">
      ...
      <div className="block lg:hidden">
        <button
          onClick={(): any => setVisible(!visible)}
          className="flex items-center px-3 py-2 border rounded text-gray-700 border-gray-700 hover:text-gray-700 hover:border-gray-700 focus:outline-none"
        >
      ...
      <div className={'w-full block flex-grow lg:flex lg:items-center lg:w-auto' + (visible ? 'flex-grow' : ' hidden')}>
